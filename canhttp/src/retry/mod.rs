...
///
/// ```rust
/// use canhttp::{Client, http::HttpRequest, HttpsOutcallError, MaxResponseBytesRequestExtension, retry::DoubleMaxResponseBytes};
/// use ic_cdk::call::{CallRejected, Error as IcError};
